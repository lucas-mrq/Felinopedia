    ...
    <Layout pageTitle="Liste des Zoos" language={"french"}>
        <Flex>
          <MapArea>
            ...
            <Zoo name="Zoo de Vincennes" color="#5A763A" border="#69675B" position={["-100","75"]} zIndex={30} onClick={() => setSelectedZoo("Vincenes")}>.</Zoo>
            <Zoo name="Zoo Amneville" color="#000000" border="#7BBEE5" position={["4","53"]} zIndex={27} onClick={() => setSelectedZoo("Amneville")}>.</Zoo>
            <Zoo name="Parrot World" color="red" border="blue" borderForm="top" position={["4","15"]} zIndex={24} onClick={() => setSelectedZoo("Lumigny")}>.</Zoo>
            ...
            <Zoo name="Domaine des Fauves" color="#FFFFFF" border="#7BBEE5" position={["-7","54"]} zIndex={12} onClick={() => setSelectedZoo("Abrets-en-Dauphiné")}>.</Zoo>
            <Zoo name="Zoo African Safari" color="#FFFFFF" border="#000000" position={["17","-11"]} zIndex={9} onClick={() => setSelectedZoo("African Safari")}>.</Zoo>
            <Zoo name="Zoo du Carbet " color="#e11b22" border="#b9d433" position={["11","-60"]} zIndex={2} onClick={() => setSelectedZoo("Carbet")}>.</Zoo>
          </MapArea>
        </Flex>
    </Layout>
  )
